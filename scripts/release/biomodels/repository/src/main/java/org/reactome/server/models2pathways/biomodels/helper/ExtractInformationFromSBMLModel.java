...
import org.reactome.server.models2pathways.biomodels.model.Bag;
import org.reactome.server.models2pathways.biomodels.model.ModelElement;
...
public class ExtractInformationFromSBMLModel {
     ...
     *
     * @param bioMdSBML BioModel SBMLModel-XML as String
     * @return Instance of SBMLModel
     */
    ...
    private static String extractNamespaceFromURI(String uri) {
        try {
            ...
            System.err.println("StringIndexOutOfBoundsException on " + uri + ", please report to BioModels.");
        }
        return null;
    }
}