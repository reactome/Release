...
print "tweak_datamodel: opt_db=$opt_db\n";
print "tweak_datamodel: opt_host=$opt_host\n";
print "tweak_datamodel: opt_port=$opt_port\n";
print "tweak_datamodel: opt_user=$opt_user\n";
...
print "tweak_datamodel: about to do a bunch of _create_singlevalue_attribute\n";
...
print "tweak_datamodel: about to change defining attributes\n";
...
print "tweak_datamodel: about to do a bunch of create_attribute_column_definitions\n";
