...
GENERAL_CLASSPATH=lib/junit-4.4.jar:lib/javaws.jar:lib/mysql-connector-java-3.0.11-stable-bin.jar:lib/mysql-connector-java-3.1.7-bin.jar:lib/osxAdapter.jar:lib/commons-lang-2.3.jar
