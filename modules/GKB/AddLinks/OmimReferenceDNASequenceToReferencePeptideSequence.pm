...
Adds OMIM entries to the referenceGene slots of ReferenceGeneProduct
...
Note that the database should be clean of any OMIM references before
you run the buildPart method of this class, otherwise you will get
fatal errors.  TODO: fix this.
...
package GKB::AddLinks::OmimReferenceDNASequenceToReferencePeptideSequence;
...
sub buildPart {
	...
	$self->class_name("OmimReferenceDNASequenceToReferencePeptideSequence");
	
	print STDERR "\n\n" . $self->class_name . ".buildPart: entered\n";
	
	$self->insert_xrefs('referenceGene', 'OMIM', 1);
}
