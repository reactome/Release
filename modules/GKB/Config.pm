...
use vars qw(
    ...
    $GK_NCBI_FTP_USER
    $GK_NCBI_FTP_PASS
    $GK_EUROPEPMC_FTP_USER
    $GK_EUROPEPMC_FTP_PASS
    $GK_EUROPEPMC_FTP_DIRECTORY
    $GK_DB_NAME
    $GK_IDB_NAME
    $GK_DB_HOST
    $GK_DB_USER
...
$GK_CURATOR_DB_USER = $GKB::Secrets::GK_CURATOR_DB_USER;
$GK_CURATOR_DB_PASS = $GKB::Secrets::GK_CURATOR_DB_PASS;
...
$GK_NCBI_FTP_USER = $GKB::Secrets::GK_NCBI_FTP_USER;
$GK_NCBI_FTP_PASS = $GKB::Secrets::GK_NCBI_FTP_PASS;
$GK_EUROPEPMC_FTP_USER = $GKB::Secrets::GK_EUROPEPMC_FTP_USER;
$GK_EUROPEPMC_FTP_PASS = $GKB::Secrets::GK_EUROPEPMC_FTP_PASS;
$GK_EUROPEPMC_FTP_DIRECTORY = $GKB::Secrets::GK_EUROPEPMC_FTP_DIRECTORY;
...
$GK_ROOT_DIR = "$REACTOME_ROOT_DIR/Release";
