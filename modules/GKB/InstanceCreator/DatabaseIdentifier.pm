...
"DatabaseIdentifier.get_database_identifier: identifier not defined!\n";
    ...
    my $database_identifier =
      $self->database_identifier_cache->{ $reference_database->db_id() }
      ->{$identifier};
    ...
    my $database_identifiers =
      $dba->fetch_instance_by_remote_attribute( 'DatabaseIdentifier', \@query );
    $database_identifier = undef;
    if ( defined $database_identifiers
        && scalar( @{$database_identifiers} ) > 0 )
    {
        # Yep, it's in there!
    ...
    $database_identifier = GKB::Instance->new(
        -ONTOLOGY => $dba->ontology,
        -CLASS    => 'DatabaseIdentifier'
    );
    $database_identifier->inflated(1);
    $database_identifier->created(
...
sub get_biogps_gene_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_biogps_gene_reference_database(),
        $identifier );
}
...
sub get_brenda_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_brenda_reference_database(),
        $identifier );
}
...
sub get_ctd_gene_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_ctd_gene_reference_database(),
        $identifier );
}
...
sub get_dbsnp_gene_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_dbsnp_gene_reference_database(),
        $identifier );
}
...
sub get_dockblaster_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_dockblaster_reference_database(),
        $identifier );
}
...
sub get_ec_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_ec_reference_database(), $identifier );
}
...
sub get_ensembl_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_ensembl_reference_database($species),
        $identifier );
}
...
sub get_entrez_gene_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_entrez_gene_reference_database(),
        $identifier );
}
...
sub get_flybase_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_flybase_reference_database(),
        $identifier );
}
...
sub get_genecards_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_genecards_reference_database(),
        $identifier );
}
...
#	return $self->get_database_identifier($self->reference_database->get_hapmap_reference_database(), $identifier);
    return $self->get_database_identifier(
        $self->reference_database->get_intact_reference_database(),
        $identifier );
}
...
sub get_intenz_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_intenz_reference_database(),
        $identifier );
}
...
sub get_kegg_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_kegg_reference_database($species),
        $identifier );
}
...
sub get_omim_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_omim_reference_database(), $identifier );
}
...
sub get_orphanet_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_orphanet_reference_database(),
        $identifier );
}
...
sub get_pdb_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_pdb_reference_database(), $identifier );
}
...
sub get_rhea_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_rhea_reference_database(), $identifier );
}
...
sub get_refseq_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_refseq_reference_database(),
        $identifier );
}
...
sub get_uniprot_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_uniprot_reference_database(),
        $identifier );
}
...
sub get_ucsc_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_ucsc_reference_database(), $identifier );
}
...
sub get_wormbase_database_identifier {
    ...
    return $self->get_database_identifier(
        $self->reference_database->get_wormbase_reference_database(),
        $identifier );
}
