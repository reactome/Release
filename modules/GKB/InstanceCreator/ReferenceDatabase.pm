...
my %reference_database_info_hash = (
    'BioGPS Gene' => {'Name' => ['BioGPS Gene'], 'URL' => "http://biogps.org/", 'AccessUrl' => "http://biogps.org/gene/###ID###"},
    'Brenda' => {'Name' => ['Brenda'], 'URL' => "http://www.brenda-enzymes.info/index.php4", 'AccessUrl' => "http://www.brenda-enzymes.info/php/result_flat.php4?ecno=###ID###"},
    'CTD Gene' => {'Name' => ['CTD Gene', 'Comparative Toxicogenomics Database Gene'], 'URL' => 'http://ctd.mdibl.org/', 'AccessUrl' => 'http://ctd.mdibl.org/detail.go?type=gene&db=GENE&acc=###ID###'},
    'dbSNP Gene' => {'Name' => ['dbSNP Gene', 'NCBI dbSNP'], 'URL' => 'http://www.ncbi.nlm.nih.gov/projects/SNP/', 'AccessUrl' => 'http://www.ncbi.nlm.nih.gov/SNP/snp_ref.cgi?locusId=###ID###'},
    'DOCK Blaster' => {'Name' => ['DOCK Blaster'], 'URL' => 'http://blaster.docking.org', 'AccessUrl' => 'http://blaster.docking.org/cgi-bin/parser.pl?code=###ID###'},
#    'EC' => {'Name' => ['EC', 'Enzyme'], 'URL' => "http://ca.expasy.org/enzyme/", 'AccessUrl' => "http://ca.expasy.org/enzyme/###ID###"},
#    'EC' => {'Name' => ['EC', 'Enzyme'], 'URL' => "http://ca.expasy.org/enzyme/", 'AccessUrl' => "http://ca.expasy.org/EC/###ID###"},
    'EC' => {'Name' => ['EC', 'Enzyme'], 'URL' => "http://www.expasy.org/enzyme/", 'AccessUrl' => "http://enzyme.expasy.org/EC/###ID###"},
    'ENSEMBL' => {'Name' => ['ENSEMBL', 'Ensembl'], 'URL' => 'http://www.ensembl.org', 'AccessUrl' => 'http://www.ensembl.org/###SP###/geneview?gene=###ID###&db=core'},
#    'Entrez Gene' => {'Name' => ['Entrez Gene'], 'URL' => 'http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?db=gene', 'AccessUrl' => 'http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?db=gene&cmd=Retrieve&dopt=Graphics&list_uids=###ID###'},
    'Entrez Gene' => {'Name' => ['Entrez Gene'], 'URL' => 'http://www.ncbi.nlm.nih.gov/sites/entrez?db=gene', 'AccessUrl' => 'http://www.ncbi.nlm.nih.gov/sites/entrez?Db=gene&Cmd=ShowDetailView&TermToSearch=###ID###'},
    'FlyBase' => {'Name' => ['FlyBase'], 'URL' => 'http://flybase.org', 'AccessUrl' => 'http://flybase.org/.bin/fbidq.html?###ID###'},
	'GeneCards' => {'Name' => ['GeneCards'], 'URL' => 'http://www.genecards.org', 'AccessUrl' => 'http://www.genecards.org/cgi-bin/carddisp.pl?id=###ID###&id_type="uniprot"'}, 
    'Gene Ontology' => {'Name' => ['Gene Ontology', 'GO'], 'URL' => 'http://www.geneontology.org'},
#    'HapMap' => {'Name' => ['HapMap'], 'URL' => 'http://www.hapmap.org', 'AccessUrl' => 'http://www.hapmap.org/cgi-perl/gbrowse/gbrowse?name=###ID###'},
    'HapMap' => {'Name' => ['HapMap'], 'URL' => 'http://www.hapmap.org', 'AccessUrl' => 'http://hapmap.ncbi.nlm.nih.gov/cgi-perl/gbrowse/hapmap3r2_B36/?name=###ID###'},
    'IntAct' => {'Name' => ['IntAct'], 'URL' => "http://www.ebi.ac.uk/intact", 'AccessUrl' => "http://www.ebi.ac.uk/intact/search/do/search?searchString=###ID###&filter=ac"},
    'IntEnz' => {'Name' => ['IntEnz'], 'URL' => "http://www.ebi.ac.uk/intenz/", 'AccessUrl' => "http://www.ebi.ac.uk/intenz/query?cmd=SearchEC&ec=###ID###"},
    'KEGG Gene' => {'Name' => ['KEGG', 'KEGG Gene'], 'URL' => "http://www.genome.jp/", 'AccessUrl' => "http://www.genome.jp/dbget-bin/www_bget?###SP3###+###ID###"},
#    'KEGG Gene' => {'Name' => ['KEGG', 'KEGG Gene'], 'URL' => "http://www.genome.jp/", 'AccessUrl' => "http://www.genome.jp/dbget-bin/www_bget?hsa+###ID###"}, # TODO: KEGG species-specific stuff is not working
#    'OMIM' => {'Name' => ['OMIM', 'MIM'], 'URL' => 'http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?db=OMIM', 'AccessUrl' => 'http://www.ncbi.nlm.nih.gov/entrez/dispomim.cgi?id=###ID###'},
    'OMIM' => {'Name' => ['OMIM', 'MIM'], 'URL' => 'http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?db=OMIM', 'AccessUrl' => 'http://www.ncbi.nlm.nih.gov/omim/###ID###'},
...
#    'PDB' => {'Name' => ['PDB', 'Protein Data Bank'], 'URL' => 'http://www.pdb.org', 'AccessUrl' => 'http://www.pdb.org/pdb/explore/explore.do?structureId=###ID###'},
    ...
    'PRO' => {'Name' => ['PRO', 'Protein Ontology'], 'URL' => 'http://pir.georgetown.edu/pro', 'AccessUrl' => 'http://purl.obolibrary.org/obo/PR_###ID###'},
    ...
    'UCSC human' => {'Name' => ['UCSC human', 'UCSC'], 'URL' => 'http://genome.ucsc.edu/', 'AccessUrl' => 'http://genome.ucsc.edu/cgi-bin/hgTracks?position=###ID###'},
    'Wormbase' => {'Name' => ['Wormbase'], 'URL' => 'http://www.wormbase.org/', 'AccessUrl' => 'http://www.wormbase.org/db/seq/sequence?name=###ID###;class=Gene_name'},
    );
...
sub get_reference_database {
	...
	if (defined $species && $self->is_multiple_species_database($name)) {
		print STDERR "ReferenceDatabase.get_reference_database: species=$species\n";
    	...
    	if (!($name =~ /$species/)) {
			...
			print STDERR "ReferenceDatabase.get_reference_database: searching for preexisting ReferenceDatabase for $species_specific_name\n";
			$reference_database = $self->get_predefined_reference_database($species_specific_name);
			if (defined $reference_database ){
				print STDERR "ReferenceDatabase.get_reference_database: found preexisting ReferenceDatabase for $species_specific_name\n";
				$self->rearrange_reference_database_names($reference_database, $name);
				return $reference_database;
			}
			print STDERR "ReferenceDatabase.get_reference_database: searching for preexisting ReferenceDatabase for $species_specific_name\_GENE\n";
			$reference_database = $self->get_predefined_reference_database("$species_specific_name\_GENE");
			if (defined $reference_database ){
				print STDERR "ReferenceDatabase.get_reference_database: found preexisting ReferenceDatabase for $species_specific_name\_GENE\n";
				$self->rearrange_reference_database_names($reference_database, $name);
				return $reference_database;
			}
    	}
		...
		print STDERR "ReferenceDatabase.get_reference_database: no species-specific database found, look for regular database\n";
	...
	print STDERR "ReferenceDatabase.get_reference_database: create brand new database\n";
	...
	$reference_database->created($self->miscellaneous->get_instance_edit_for_effective_user());
...
sub get_predefined_reference_database {
    ...
    my $reference_databases = $dba->fetch_instance_by_attribute('ReferenceDatabase',[['name',[$local_name]]]);
...
sub get_url {
    ...
    if (!($dont_use_muiriam_hash{$name})) {
	    ...
	    if (defined $data_resources && scalar($data_resources) =~ /ARRAY/ && scalar(@{$data_resources})>0) {
    ...
    if (defined $url) {
    	...
    	if ($url =~ /###SP3###/) {
	    	...
	    	if (defined $species3) {
				...
				print STDERR "ReferenceDatabase.get_url: WARNING - species3 is undef for $species!!\n";
	    	}
    	}
    } else {
		print STDERR "ReferenceDatabase.get_url: WARNING - Could not find URL for service $name\n";
    }
...
sub get_access_url {
    ...
    if (!(defined $access_url)) {
	    ...
	    if (!($dont_use_muiriam_hash{$name})) {
		    ...
		    if (defined $locations && scalar($locations) =~ /ARRAY/ && scalar(@{$locations})>0) {
    ...
    if (defined $access_url) {
    	...
    	if ($access_url =~ /###SP3###/) {
	    	...
	    	if (defined $species3) {
				...
				print STDERR "ReferenceDatabase.get_access_url: WARNING - species3 is undef for $species!!\n";
	    	}
    	}
    } else {
		print STDERR "ReferenceDatabase.get_access_url: WARNING - Could not find access URL for service $name\n";
    }
...
sub get_names {
    ...
    if (!($dont_use_muiriam_hash{$name})) {
	    ...
	    if (defined $data_type_synonyms && scalar($data_type_synonyms) =~ /ARRAY/ && scalar(@{$data_type_synonyms})>0) {
    ...
    if (scalar(@names) == 0) {
		print STDERR "ReferenceDatabase.get_names: Could not find alternative names for service $name\n";
    	@names = ();
    }
    
    print STDERR "ReferenceDatabase.get_names: 1 names=@names\n";
    
	if ($self->is_multiple_species_database($name) && defined $species && !($name =~ /$species/)) {
		...
		print STDERR "ReferenceDatabase.get_names: species_specific_name=$species_specific_name\n";
...
sub get_ensembl_reference_database {
	...
	print STDERR "ReferenceDatabase.get_ensembl_reference_database: species=$species\n";
